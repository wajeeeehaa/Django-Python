"""
Django settings for istproject project.
...
SECRET_KEY = "django-insecure-%9h@o5r6r@zsdmy%_u$q=p$^r)w&+k$xqh%_wja2&0%0#j+s%w"
...
WSGI_APPLICATION = "istproject.wsgi.application"
...
# AUTH_USER_MODEL = 'bugzilla.CustomUser'

AUTHENTICATION_BACKENDS = [
    'students.backends.EmailBackend',  # Custom backend allows email login
]
